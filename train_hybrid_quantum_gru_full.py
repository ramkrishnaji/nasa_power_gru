...
# =========================
# 2) DATALOADERS (SMALL BATCH)
# =========================
BATCH_SIZE = 4  # quantum is slow, keep small
...
print("\nTraining Hybrid Quantum GRU (NOISELESS) [FULL DATA]...")
...
print("\n✅ Hybrid Quantum GRU Results (NOISELESS) [FULL DATA]:")
print("MAE :", test_mae)
print("RMSE:", test_rmse)

torch.save(model.state_dict(), "hybrid_quantum_gru_noiseless_full.pth")
print("\nSaved model: hybrid_quantum_gru_noiseless_full.pth")
